...
import { CoundownTimer } from "@/components/coundown-timer";
...
export default function Home() {
  ...
  const [showBackground, setShowbackdground] = useState(false);
  const buttonRef = useRef<HTMLButtonElement>(null)

  useEffect(()=>{
    setShowbackdground(true);
  },[])
  useEffect( () => {
    let currentIndex = 0
  ...
  return (
    <main>
      ...
      src={assets.gradient} alt="gradient"/>
      ...
      <div className="max-w-7xl mt-20 mx-auto">
        <div className="flex flex-col items-center relative z-10">
          ...
          <CoundownTimer currentFramework={currentFramework}/>
        </div>
      </div>
